...
card.addDollars(1); // add 100 cents @ 20 cents/minute = 5 minutes added
phone2.call("555-4444");
phone2.tick();       // 1 minute elapsed
phone2.tick();       // 2 minutes elapsed
phone2.tick();       // 2 minutes elapsed
phone2.tick();       // 2 minutes elapsed
phone.endCall();

phone2.call("555-5555");
phone2.tick();       // 3 minutes elapsed

phone2.getHistory(); // => returns "555-1111 (2 minutes), 555-3333 (cut of at 3 minutes)"
